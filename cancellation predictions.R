...
# change working directory to the folder where you store your files
setwd("C://Users//user//OneDrive - City University of Hong Kong//ML for Bus//hotel booking demand")
